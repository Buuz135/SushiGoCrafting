...
public class SeaWeedFeature extends Feature<NoFeatureConfig> {
    ...
    @Override
    public boolean generate(ISeedReader p_230362_1_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, NoFeatureConfig p_230362_6_) {
        int i = 0;
        ...
        if (p_230362_1_.getBlockState(blockpos).matchesBlock(Blocks.WATER)) {
            ...
            for (int l = 0; l <= k; ++l) {
                if (p_230362_1_.getBlockState(blockpos).matchesBlock(Blocks.WATER) && p_230362_1_.getBlockState(blockpos.up()).matchesBlock(Blocks.WATER) && blockstate1.isValidPosition(p_230362_1_, blockpos)) {
                    if (l == k) {
                    ...
                    if (blockstate.isValidPosition(p_230362_1_, blockpos1) && !p_230362_1_.getBlockState(blockpos1.down()).matchesBlock(Blocks.KELP)) {
